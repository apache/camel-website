...
of Camel K. This version introduces a new [logging trait](/camel-k/2.11.x/traits/logging.html) that simplifies access to the logging configuration available on the runtime.
