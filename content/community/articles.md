...
*   [Apache Camel vs Apache Kafka](http://www.masterspringboot.com/camel/apache-camel-vs-apache-kafka/) - by Francesco Marchioni. Comparing the common use cases for Apache Camel and Apache Kafka
*   [Consuming and producing Kafka Messages with Camel](http://www.masterspringboot.com/camel/consuming-and-producing-kafka-messages-from-camel/) - by Francesco Marchioni. A simple Camel route example to produce and consume Kafka messages with Camel
...
*   [From inside the code: Camel RouteBuilder and Java DSL](https://blog.christianposta.com/camel/from-inside-the-code-camel-routebuilder-and-java-dsl/) - A deep dive into the internals of Apache Camel to see how the Java [DSL](../../manual/dsl.html) works
...
*   [Using basic authentication and Jetty realms to protect Apache Camel REST routes](http://www.mooreds.com/wordpress/archives/2065) from June 2015 by Dan Moore writes how to use basic auth with the [Rest DSL](../../manual/rest-dsl.html) and Jetty as component.
