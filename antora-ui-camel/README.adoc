...
Some of the sample content in [.path]_preview-src/_ (the AsciiDoc showcase pages and their supporting `ui-model.yml` and images) is adapted from
https://github.com/bonitasoft/bonita-documentation-theme[bonita-documentation-theme], copyright its authors and also licensed under MPL-2.0.
